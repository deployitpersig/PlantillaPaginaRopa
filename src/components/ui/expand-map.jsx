...
export function LocationMap({
  ...
  return (
    <motion.div
      ref={containerRef}
      className={`relative cursor-pointer select-none flex items-center justify-center w-full h-full ${className}`}
      style={{
        perspective: 1000,
      }}
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-2xl bg-[#111] border border-white/10 flex flex-col justify-center"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white/[0.05] via-transparent to-white/[0.1]" />
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              />
              <motion.div
                className="absolute top-[55%] left-[5%] w-[8%] h-[12%] rounded-sm bg-white/5 border border-white/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.65 }}
              />
              <motion.div
                className="absolute top-[8%] left-[75%] w-[14%] h-[10%] rounded-sm bg-white/10 border border-white/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-5">
          ...
          <div className="flex items-start justify-between">
            ...
            >
              ...
              <span className="text-[10px] font-medium text-[#888] tracking-wide uppercase">Activo</span>
            </motion.div>
          </div>

          {/* Bottom section */}
          <div className="space-y-1 self-start w-full text-left">
            <motion.h3
      ...
      {/* Click hint */}
      <motion.p
        className="absolute -bottom-6 left-1/2 text-[10px] text-[#888] whitespace-nowrap"
